...
# 需要：PACC 客户端（ptv-client-4.0.0.jar 或原生探针）、所在目录下的 pacc-client.properties。
...
Write-Host "== PACC v4.0 Windows 安装程序 ==" -ForegroundColor Cyan
...
Write-Host "已就绪。请将 ptv-client-4.0.0.jar / 原生探针部署到 $BinDir 并配置服务。" -ForegroundColor Yellow
